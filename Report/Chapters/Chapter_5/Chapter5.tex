...
to the frequent ones \citep{Charte2015AddressingII}. Some matter more than others,
...
\citep{bce_loss, Charte2015AddressingII}. Focal Loss down-weights easy examples,
but it still scores each label in isolation \citep{lin2018focallossdenseobject}.
...
\begin{itemize}
	...
	based on DPO \citep{rafailov2023direct}, CPO
	\citep{xu2024contrastivepreferenceoptimizationpushing}, and SimPO
	\citep{meng2024simposimplepreferenceoptimization}.
...
This variant adapts SimPO \citep{meng2024simposimplepreferenceoptimization} to give
...
The last variant adapts CPO \citep{xu2024contrastivepreferenceoptimizationpushing},
...
\citep{lin2015microsoftcococommonobjects} and NUS-WIDE \citep{chua2009nus}.
...
\citep{dosovitskiy2021imageworth16x16words}, pre-trained on ImageNet-21k and
...
objectives. Group DRO + BCE \citep{sagawa2019distributionally} applies
...
with AdamW \citep{loshchilov2019decoupledweightdecayregularization}. We train for at
...
\begin{table}[t]
	...
	\adjustbox{max width=\textwidth}{%
		\begin{tabular}{lcccccccc}
			...
			GDRO + BCE \citep{sagawa2019distributionally}  & 87.92$_{\pm 0.12}$ & 90.41$_{\pm 0.09}$ & 62.31$_{\pm 0.20}$ & 64.75$_{\pm 0.13}$ & 95.72$_{\pm 0.10}$ & 98.05$_{\pm 0.05}$ & -0.43 & -0.24$^{\ddagger}$ \\
			Focal Loss \citep{lin2018focallossdenseobject} & 88.35$_{\pm 0.14}$ & 89.81$_{\pm 0.12}$ & 63.15$_{\pm 0.16}$ & 64.18$_{\pm 0.15}$ & 96.11$_{\pm 0.12}$ & 97.90$_{\pm 0.07}$ & Ref   & -0.84 \\
			\midrule
...
\begin{table}[t]
	...
	\adjustbox{max width=\textwidth}{%
		\begin{tabular}{lcccccccc}
			...
			GDRO + BCE \citep{sagawa2019distributionally}  & 64.84$_{\pm 0.16}$ & 69.91$_{\pm 0.12}$ & 49.13$_{\pm 0.22}$ & 55.62$_{\pm 0.15}$ & 92.11$_{\pm 0.13}$ & 95.13$_{\pm 0.09}$ & -0.97 & -0.33 \\
			Focal Loss \citep{lin2018focallossdenseobject} & 65.81$_{\pm 0.17}$ & 68.95$_{\pm 0.15}$ & 50.33$_{\pm 0.20}$ & 54.31$_{\pm 0.18}$ & 93.05$_{\pm 0.11}$ & 94.75$_{\pm 0.11}$ & Ref   & -1.29 \\
			\midrule
