...
\section{Language-Specific Neurons in Multilingual Models}
...
English-centric processing claim during training, and finds that GRPO leaves the
per-layer language pattern unchanged, so it does not cause cross-lingual collapse,
and that the language it cannot move tracks tokeniser coverage rather than
language identity.
